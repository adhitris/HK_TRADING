...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/js/unit/unit_search.js?v=${countVersionJs}"></script>
			        	...
			        	<tr>
			          	...
			          	<tr>
			            	<td width="200"><strong>Nama</strong></td>
			              	<td width="200"><input name="nama" type="text" class="nama" id="nama"/></td>
			                <td width="200"></td>
			          	</tr>
...
<div class="onecolumn">
	<div class="header">
			...
			<span style="padding: 9" class="tip"> 
					<a title="Tambah Data"  href="#" id="addUnit">
			...
			<span style="padding: 9" class="tip"> 
					<a title="Ubah Data"  href="#" id="updateUnit">
			...
			<span style="padding: 9;align:right;" class="tip"> 
					<a title="Hapus Data"  href="#" id="deleteUnit">
