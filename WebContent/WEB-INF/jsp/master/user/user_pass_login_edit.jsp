...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/js/user/user_pass_login_edit.js?v=${countVersionJs}"></script>
			...
			<tr>
          	...
          	<tr>
            	<td><strong>Password Login</strong></td>
              	<td><input name="password" type="password" id="password" size="33" maxlength="50" /></td>
                <td><span id="passwordInfo"></span></td>
          	</tr>
          	<tr>
            	<td><strong>Confirm Password</strong></td>
              	<td><input name="confirmPassword" type="password" id="confirmPassword" size="33" maxlength="50" /></td>
                <td><span id="confirmPasswordInfo"></span></td>
          	</tr>
