...
$(document).ready(function(){	
		...
		var completeUrl=getUrl+'/images/icon/totop.png';
...
var scrolltotop={
	...
	controlHTML: '<img src="/HK/assets/images/icon/totop.png" style="width:21px;height:21px;" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
